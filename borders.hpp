...
{
	public:
		void update(sf::RenderWindow *, sf::View *, main_c *, float);
		void set_dims (float, float);
		void mc_interact (sf::View *, main_c *, float);
...
void border::mc_interact(sf::View * View, main_c * main_char, float dd)
{
...
void border::update(sf::RenderWindow * App, sf::View * View, main_c * main_char, float vs)
{
